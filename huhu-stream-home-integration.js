/* AET ALBAN ELOH TECHNOLOGIE — Huhu Quick Launcher */
(function(){
  'use strict';
  const ID='aet-alban-fab';
  ...
  box.innerHTML=`<div class="panel"><div class="title">AET ALBAN ELOH TECHNOLOGIE</div><div class="grid"><button class="btn primary" data-go="https://huhu.to/live">TV Live</button><button class="btn ghost" data-go="https://huhu.to/movies">Films</button><button class="btn ghost" data-go="https://huhu.to/series">Séries</button><button class="btn ghost" data-copy="1">Copier URL</button></div><div class="field"><input id="aetInput" type="url" placeholder="Coller une URL huhu / HLS / MP4" /></div><div class="grid"><button class="btn primary" data-open-input="1">Ouvrir</button><button class="btn ghost" data-open-home="1">Accueil Huhu</button></div></div><button class="fab">AET</button>`;
